 ...
 *       <a href="https://tools.ietf.org/html/rfc2818#section-3.1">the section 3.1 of RFC2818</a></li> // hostname 模式
 *   <li>{@link SslContext} if TLS is enabled</li>
 *   <li>the list of available {@link Service}s and their {@link Route}s</li>  可用的Services和可用的Routes
 * </ul>
 *
...
public final class VirtualHost {
    ...
    /**
     * 实际上就是项目内，所有的Service内包含的path集合； 当前集合里的每一个元素内都含有一个当前VirtualHost的引用！
     */
    private final List<ServiceConfig> services;
    /**
     * 实际上就是项目内，所有的Routes集合
     */
