...
public enum ExceptionVerbosity {
     ...
     * </ul>
     * <br/>
     * 记录那些没有被{@link ExceptionHandler}处理的所有异常， 除了{@link IllegalArgumentException}{@link HttpStatusException}{@link HttpResponseException}以外。
     */
    UNHANDLED,
    /**
     * Do not log any exceptions.  不记录任何的异常
     */
    NONE
}
