...
public class ThrottlingHttpService extends ThrottlingService<HttpRequest, HttpResponse> {
     ...
     * <br/>
     * 创建一个装饰器通过{@link ThrottlingStrategy}实例
     * @param strategy The {@link ThrottlingStrategy} instance to be used  参数: 即将要被使用的策略实例
     */
     ...
     * <br/>
     * 创建一个新的实例， 通过传入的{@link Service}对象和"掐死策略"
     */
     ...
     * <br/>
     * 当请求被"掐死"的时候， 会快速告诉调用者失败的原因{@link HttpStatus#SERVICE_UNAVAILABLE}. 可以理解为FailFast
     */
    @Override
