 ...
 * >
 * >     @RequestObject
 * >     private Frank f;                           // Would be converted by the class-level converter.   使用类级别指定的转化器
 * >
 * >     private String g;                          // No conversion would be performed. 'null' would be set.
 * >
 * >     @RequestConverter(AliceConverter.class)    // @RequestObject would be applied implicitly.  // 使用成员变量指定的转化器
 * >     public CompositeBean(Alice a) { ... }
 * >
 * >     @RequestConverter(CharlieConverter.class)  // @RequestObject would be applied implicitly.  // 使用成员方法指定的转化器
 * >     public void setCharlie(Charlie c) { ... }
 * >
 * >     // @RequestObject would be applied implicitly.                                             // 使用成员方法指定的转化器
