...
public final class EndpointGroupRegistry {
     ...
     * <br/>
     * 返回一个与groupName相关联的{@link EndpointSelector}
     * @return the {@link EndpointSelector}, or {@code null} if {@code groupName} has not been registered yet. 如何groupName还没有注册，则返回null
     */
    @Nullable
     ...
     * <br/>
     * 从传入的ClientRequestContext内的EndpointGroup内挑选一个Endpoint
     */
