...
class FileWatcherRunnable implements Runnable {
     ...
     * <br/>
     * 一个工具集，对于每一个要监视的path，都包含了其对应的上下文的信息
     */
    static class FileWatchEvent {
         ...
         * @param watchKey the {@link WatchKey} registered for the current path  注册到当前path的WatchKey
         * @param callback the callback which is invoked on a watch event   // 回调函数
         * @param dirPath path which is watched     // 需要被监控的path
         */
