...
public abstract class RetryingClient<I extends Request, O extends Response>
     ...
     * <br/>
     * 该header表示了当前request的重试次数，且服务端必需依赖该header对应的值来拒绝过多的重连操作
     */
     ...
     * <br/>
     * 返回RetryStrategy， 如果未被设置，则会抛出IllegalStateException。
     ...
     * <br/>
     * 返回RetryStrategyWithContent， 如果未被设置，则会抛出IllegalStateException
     *
     ...
     * 派生一个新的{@link ClientRequestContext}，用传入的req替换掉原先的{@link Request}
     */
