 ...
 * <br/>
 * 中断器执行策略。
 * 决定了一个Response是否被当做Success或被当做Failure来报告给{@link CircuitBreaker}。一般是通过响应Header头来做出决定。
 * 如果你想通过Response的内容来决定本次请求是否成功，那么应该选取{@link CircuitBreakerStrategyWithContent}
 */
@FunctionalInterface
public interface CircuitBreakerStrategy {
     ...
     * <br/>
     * 当响应状态不是{@link HttpStatusClass#SERVER_ERROR}且没有异常抛时候，将会返回一个把Response当做成功的{@link CircuitBreakerStrategy}
     */
