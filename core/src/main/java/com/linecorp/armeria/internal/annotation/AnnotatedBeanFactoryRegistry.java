 ...
 * <br/>
 * 管理着创建Bean的工厂
 * 首次调用{@link #register(Class, Set, List)}，让AnnotatedBeanFactoryRegistry为目标Bean创建一个AnnotatedBeanFactory
 *
 */
final class AnnotatedBeanFactoryRegistry {
     ...
     * <br/>
     * 将指定的 {@link Class} and {@code pathParams}的factory注册进factories
     */
    ...
    /**
     * 创建与beanFactoryId对应的工厂
     * @param beanFactoryId
     * @param objectResolvers  RequestObjectResolver的集合，其用来转换req到Object
     * @param <T>
     * @return 并将其返回
     */
    @Nullable
