 ...
 * <br/>
 * 多个options对象和他们各自对应值的存储容器
 *
 *
 *
 * @see AbstractOption   类比于Map， 这就是key
 * @see AbstractOptionValue 类比于Map， 这就是value
 */
public abstract class AbstractOptions {
    ...
    protected <T extends AbstractOptionValue<?, ?>> AbstractOptions(Function<T, T> valueFilter, T... values) {
        ...
        // TODO HashMap 比较的是 k.equal(key)[比较的是内容]; 而 IdentityHashMap比较的是 k == key[即比较的是对象地址]
