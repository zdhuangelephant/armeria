...
public final class CommonPools {
    ...
    static {
        // Threads spawned as needed and reused, with a 60s timeout and unbounded work queue.  200 threads from tomcat default setting
     ...
     *
     * <br/>
     * 如果用户没有显示的设置workGroup，则会默认使用WORKER_GROUP
     */
