...
public interface RpcResponse extends Response, Future<Object>, CompletionStage<Object> {
     ...
     *
     * NOTE: 基于某个{@link CompletionStage}的完成结果来创建一个成功或失败的rpcResponse
     */
     ...
     *
     * NOTE: 返回一个{@link CompletableFuture}，当RpcResponse完成以后
     */
    @Override
